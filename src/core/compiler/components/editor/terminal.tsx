...
import { useEditorStore, TerminalTab } from './store'
...
export const TerminalTabs = () => {
  const { activeTab, isTerminalOpen, toggleTerminalOpen, setActiveTab } = useEditorStore()
...
export const TerminalContent = ({ testResults, executionOutput }: TerminalContentProps) => {
  const { activeTab, isTerminalOpen, setActiveTab, toggleTerminalOpen } = useEditorStore()
