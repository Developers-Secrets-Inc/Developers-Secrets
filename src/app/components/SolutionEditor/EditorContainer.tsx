...
import SolutionEditor from '../../(frontend)/(dashboard)/challenges/create-solution/components/index'
import EditorToolbar from '../../(frontend)/(dashboard)/challenges/create-solution/components/EditorToolbar'
