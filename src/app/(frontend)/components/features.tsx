...
const defaultFeatures: FeatureItem[] = [
  {
    ...
    image: '/images/features/placeholder-1.svg',
    description:
  ...
  },
  {
    ...
    image: '/images/features/placeholder-2.svg',
    description:
  ...
  },
  {
    ...
    image: '/images/features/placeholder-3.svg',
    description:
  ...
  },
  {
    ...
    image: '/images/features/placeholder-4.svg',
    description:
  ...
  },
  {
    ...
    image: '/images/features/placeholder-5.svg',
    description:
...
export const Feature197 = ({ features = defaultFeatures }: Feature197Props) => {
  const [activeTabId, setActiveTabId] = useState<number | null>(
    features.length > 0 ? features[0].id : null,
  )
  const [activeImage, setActiveImage] = useState(features.length > 0 ? features[0].image : '')
            ...
            <Accordion type="single" className="w-full" defaultValue="item-1">
              {features.map((tab) => (
                <AccordionItem key={tab.id} value={`item-${tab.id}`}>
                  ...
                  <AccordionContent>
                    <p className="mt-3 text-muted-foreground text-base">{tab.description}</p>
