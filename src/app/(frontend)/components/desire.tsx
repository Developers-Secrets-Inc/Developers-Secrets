  ...
  messenger: () => (
    <svg width="100" height="100" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        d="M44,23.5C44,34.27,35.05,43,24,43c-1.651,0-3.25-0.194-4.784-0.564\tc-0.465-0.112-0.951-0.069-1.379,0.145L13.46,44.77C12.33,45.335,11,44.513,11,43.249v-4.025c0-0.575-0.257-1.111-0.681-1.499C6.425,34.165,4,29.11,4,23.5C4,12.73,12.95,4,24,4S44,12.73,44,23.5z"
      />
      <path
        d="M34.992,17.292c-0.428,0-0.843,0.142-1.2,0.411l-5.694,4.215\tc-0.133,0.1-0.28,0.15-0.435,0.15c-0.15,0-0.291-0.047-0.41-0.136l-3.972-2.99c-0.808-0.601-1.76-0.918-2.757-0.918\tc-1.576,0-3.025,0.791-3.876,2.116l-1.211,1.891l-4.12,6.695c-0.392,0.614-0.422,1.372-0.071,2.014\tc.358,0.654,1.034,1.06,1.764,1.06c0.428,0,0.843-0.142,1.2-0.411l5.694-4.215c0.133-0.1,0.28-0.15,0.435-0.15\tc0.15,0,0.291,0.047,0.41,0.136l3.972,2.99c0.809,0.602,1.76,0.918,2.757,0.918c1.576,0,3.025-0.791,3.876-2.116l1.211-1.891\tl4.12-6.695c0.392-0.614,0.422-1.372,0.071-2.014C36.398,17.698,35.722,17.292,34.992,17.292L34.992,17.292z"
        opacity=".05"
      />
      <path
        d="M34.992,17.792c-0.319,0-0.63,0.107-0.899,0.31l-5.697,4.218\tc-0.216,0.163-0.468,0.248-0.732,0.248c-0.259,0-0.504-0.082-0.71-0.236l-3.973-2.991c-0.719-0.535-1.568-0.817-2.457-0.817\tc-1.405,0-2.696,0.705-3.455,1.887l-1.21,1.891l-4.115,6.688c-0.297,0.465-0.32,1.033-0.058,1.511c0.266,0.486,0.787,0.8,1.325,0.8\tc0.319,0,0.63-0.107,0.899-0.31l5.697-4.218c0.216-0.163,0.468-0.248,0.732-0.248c0.259,0,0.504,0.082,0.71,0.236l3.973,2.991\tc0.719,0.535,1.568,0.817,2.457,0.817c1.405,0,2.696-0.705,3.455-1.887l1.21-1.891l4.115-6.688c0.297-0.465,0.32-1.033,0.058-1.511C36.051,18.106,35.531,17.792,34.992,17.792L34.992,17.792z"
        opacity=".07"
      />
      <path
        fill="#ffffff"
  ...
  return (
    <>
      ...
      <section className="border-t border-border">
        <div
          className="relative flex h-[340px] w-full items-center justify-center overflow-visible p-10"
          ref={containerRef}
        >
          {/* Layout: User at left, two main branches, all end at Google */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2">
            <Circle ref={userRef} className="bg-primary/10 border-primary/20">
          ...
          <div className="absolute left-1/4 top-[20%]">
            <Circle ref={pythonRef}>
              <PythonLogoIcon width={32} height={32} />
            </Circle>
          </div>
          <div className="absolute left-1/2 top-[10%]">
            <Circle ref={sqlRef}>
              <PostgreSqlLogoIcon width={32} height={32} />
            </Circle>
          </div>
          <div className="absolute left-[62%] top-[2%]">
            <Circle ref={fastapiRef}>
              <FastApiLogoIcon width={32} height={32} />
            </Circle>
          </div>
          <div className="absolute left-[62%] top-[18%]">
            <Circle ref={djangoRef}>
              <DjangoLogoIcon width={32} height={32} />
            </Circle>
          </div>
          {/* JS branch (bottom) */}
          <div className="absolute left-1/4 bottom-[20%]">
            <Circle ref={jsRef}>
              <JsLogoIcon width={32} height={32} />
            </Circle>
          </div>
          <div className="absolute left-1/2 bottom-[10%]">
            <Circle ref={tsRef}>
              <TypescriptLogoIcon width={32} height={32} />
            </Circle>
          </div>
          <div className="absolute left-[62%] bottom-[18%]">
            <Circle ref={reactRef}>
              <ReactLogoIcon size={32} />
            </Circle>
          </div>
          <div className="absolute left-[75%] bottom-[10%]">
            <Circle ref={nextjsRef}>
              <NextjsLogoIcon width={32} height={32} />
            </Circle>
          </div>
          {/* Google (final node) */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2">
            <Circle ref={googleRef}>
              {/* Google Drive icon conservée */}
          ...
          {/* Beams (edges) */}
          {/* User → Python → SQL → FastAPI/Django → Google */}
          <AnimatedBeam containerRef={containerRef} fromRef={userRef} toRef={pythonRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={pythonRef} toRef={sqlRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={sqlRef} toRef={fastapiRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={sqlRef} toRef={djangoRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={fastapiRef} toRef={googleRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={djangoRef} toRef={googleRef} />

          {/* User → JS → TS → React → Next.js → Google */}
          <AnimatedBeam containerRef={containerRef} fromRef={userRef} toRef={jsRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={jsRef} toRef={tsRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={tsRef} toRef={reactRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={reactRef} toRef={nextjsRef} />
          <AnimatedBeam containerRef={containerRef} fromRef={nextjsRef} toRef={googleRef} />
        </div>
      </section>
    </>
  )
