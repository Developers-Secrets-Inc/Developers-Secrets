...
export const PythonLogoIcon: React.FC<PythonLogoIconProps> = ({ size = 16, ...props }) => {
  ...
  return (
    <svg
      ...
      {...props} // Passer les autres props (className, width, height, etc.)
    >
      <defs id="defs4">
        <linearGradient id="linearGradient4671">
          <stop style={{ stopColor: '#ffd43b', stopOpacity: 1 }} offset="0" id="stop4673" />
          <stop style={{ stopColor: '#ffe873', stopOpacity: 1 }} offset="1" id="stop4675" />
        </linearGradient>
        <linearGradient id="linearGradient4689">
          <stop style={{ stopColor: '#5a9fd4', stopOpacity: 1 }} offset="0" id="stop4691" />
          <stop style={{ stopColor: '#306998', stopOpacity: 1 }} offset="1" id="stop4693" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          y2="114.39767"
        />
        {/* Radial gradient non utilisé directement dans les chemins principaux, peut être omis pour la simplicité si non essentiel */}
        {/* <radialGradient id="radialGradient1480" ... /> */}
      </defs>
      <path
      ...
      <path
        ...
        id="path1950"
      />
      {/* L'ellipse d'ombre peut être omise pour simplifier ou ajoutée si nécessaire */}
      {/* <ellipse id="path1894" ... /> */}
    </svg>
  )
}
