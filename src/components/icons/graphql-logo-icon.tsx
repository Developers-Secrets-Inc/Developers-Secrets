...
interface GraphQLLogoIconProps extends React.SVGProps<SVGSVGElement> {
  title?: string
}

export const GraphQLLogoIcon: React.FC<GraphQLLogoIconProps> = ({
  title = 'GraphQL Logo',
  ...props
}) => {
  const titleId = useId()
...
GraphQLLogoIcon.displayName = 'GraphQLLogoIcon'
