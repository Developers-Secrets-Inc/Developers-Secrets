...
export function News({ articles }: { articles: NewsArticle[] }) {
  ...
  return cards.length || showCompleted ? (
    <div className="group overflow-hidden pt-4" data-active={cardCount !== 0}>
      <div className="relative size-full">
        ...
        {showCompleted && !cardCount && (
          ...
          >
            <div className="animate-fade-in absolute inset-0 rounded-md border border-border [animation-delay:2.3s] [animation-direction:reverse] [animation-duration:0.2s]" />
  ...
  return (
    <Card
      ...
      className={cn(
        ...
        'transition-shadow data-[dragging=true]:shadow-md rounded-md',
      )}
