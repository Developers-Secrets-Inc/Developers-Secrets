...
export const Challenges: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        // Fields for each element in the array (represents impacts for ONE skill)
        {
          name: 'skill',
          label: 'Target Skill',
          type: 'relationship',
        ...
        },
        {
          ...
          blocks: [
            ...
            },
            {
              ...
              labels: {
                singular: 'Base Concept Impact',
                plural: 'Base Concept Impacts',
              },
              fields: [
                {
                  name: 'concept', // Referencing the base/abstract concept
                  label: 'Base Concept',
                  type: 'relationship',
                  relationTo: 'concepts',
                  required: true,
